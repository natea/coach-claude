...
- **notes**: The quantity/reps (e.g., "5 reps", "10 reps", "2 sets of 10")
...
```
log_workout(type="exercise", name="pushups", duration=20, notes="5 reps")
log_workout(type="stretch", name="neck roll", duration=30)
log_workout(type="exercise", name="squats", duration=45, notes="15 reps")
```
